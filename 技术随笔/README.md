...
* [build.gradle文件里自定义属性](#3build.gradle文件里自定义属性)
...
在App工程中统一配置版本参数和dependencies的参数，需要一个统一config.gradle管理和配置
-- 新建一个config.gradle文件
```java
ext {
    sdkversion = "1.0.0"
...
```
-- 在Project根目录的build.gradle文件添加这文件
```java
apply from: "config.gradle"
```
-- 在Module的gradle文件或manifest文件中使用
```java
android {
